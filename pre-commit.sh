...
# Check for goimports
if [[ ! -x "$GOIMPORTS" ]]; then
  printf "\t\033[41mPlease install goimports\033[0m (go get -u golang.org/x/tools/cmd/goimports)"
  exit 1
fi
...
do
  ...
  go test ./...
  if [[ $? != 0 ]]; then
    printf "\t\033[31test\033[0m \033[0;30m\033[41mFAILURE!\033[0m\n"
    PASS=false
  else
    printf "\t\033[32mtest\033[0m \033[0;30m\033[42mpass\033[0m\n"
  fi
